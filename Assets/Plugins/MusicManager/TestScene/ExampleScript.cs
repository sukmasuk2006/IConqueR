...
public class ExampleScript : MonoBehaviour
{
	void OnGUI()
	{
		...
		if(player.audio.clip != null)
		{
			GUI.Label(new Rect(20+width, 10, 200, 30), "Music: "+player.audio.clip.name);
			GUI.Label(new Rect(20+width, 40, 200, 30), "Volume: "+player.audio.volume);
			GUI.Label(new Rect(20+width, 70, 200, 30), "Is playing: "+player.audio.isPlaying);
		}
	}
}
